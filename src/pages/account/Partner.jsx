import { Add, Analytics, Policy, Settings } from "@mui/icons-material";
          ...
          <Paper elevation={0} sx={{ p: 1, position: "sticky", top: 0 }}>
            ...
            <Stack gap={0.2} color={"grey"} my={1}>
              <Button
                ...
                color={
                  pathname === "/account/payment/partner"
                    ? "success"
                    : "inherit"
                }
                startIcon={<RxAvatar />}
              ...
              <Button
                ...
                startIcon={<Add />}
                color={
                  pathname === "/account/payment/partner/context-payout"
                    ? "success"
                    : "inherit"
                }
                size="small"
                fullWidth
                component={Link}
                to="/account/payment/partner/context-payout"
              >
                Contest Payout
              </Button>
